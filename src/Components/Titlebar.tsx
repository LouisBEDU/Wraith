  ...
  return (
    <div className="titlebar">
      ...
      <div className="controls">
        <button onClick={handleMinimize} title={t("titlebar.minimize")}>
        ...
        <button onClick={handleMaximize} title={t("titlebar.maximize")}>
        ...
        <button onClick={handleClose} title={t("titlebar.close")} className="close-btn">
